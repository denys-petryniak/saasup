...
const featuresSection = ref({
  subtitle: 'Features',
  title: 'Powerful features to boost your productivity',
  cards: [
    {
      img: {
...
const getBodyBackground = computed(() => {
  ...
  return `url('${bodyBackgroundUrl}') no-repeat top right/70%, url('${bodyBackgroundDecorUrl}') no-repeat top right/cover`
})
  ...
  style: [
    {
      ...
      innerHTML: `
        @media (min-width: 1280px) {
          body {
            background: ${getBodyBackground.value};
          }
        }
      `,
    },
